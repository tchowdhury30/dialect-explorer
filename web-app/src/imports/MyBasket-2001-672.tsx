import svgPaths from "./svg-ixc5uwmuox";
...
function EmptyBasket() {
  return (
    <div
      className="absolute bg-neutral-200 left-[25px] rounded-3xl top-[194px] w-[327px]"
      data-name="empty basket"
    >
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col gap-4 items-start justify-start p-[24px] relative w-[327px]">
